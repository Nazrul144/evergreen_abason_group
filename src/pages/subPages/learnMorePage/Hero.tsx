    ...
    <div>
      <div className="lg:px-44 md:px-10 lg:mt-20 dark:bg-gray-900">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-16">
          ...
          <motion.p
            className="mt-6 md:mt-0 max-w-md text-gray-600 dark:text-gray-300 text-sm leading-relaxed text-justify"
            initial={{ x: 100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{
              delay: 0.2,
      ...
      >
        <Image src="/Learn_More/image1.jpg" alt="bannerImage" fill className="object-cover" />

        <div className="absolute inset-0 bg-black/40 bg-opacity-40"></div>

        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className={`${anton.className} text-5xl font-black text-white`}>
