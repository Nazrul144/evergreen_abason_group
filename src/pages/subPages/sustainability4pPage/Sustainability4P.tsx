      ...
      <div className="flex flex-col lg:flex-row justify-between px-4 sm:px-6 md:px-10 lg:px-44 lg:mt-20 dark:bg-gray-900 gap-6">
        ...
        >
          <div className="flex items-center space-x-2">
            <h3 className="text-[#6A7282] dark:text-gray-300 text-sm sm:text-base">
              Our way
            </h3>
        ...
        >
          <p className="text-sm sm:text-base leading-relaxed">
            Evergreen Abason Group embraces a holistic approach to
            sustainability through our 5P Model, ensuring every initiative
            creates meaningful, lasting value for our partners, our people, our
            projects, our practices, and the places we serve.
          </p>
        </motion.div>
      </div>
      ...
      <div className="px-4 sm:px-6 md:px-10 lg:px-44 lg:mt-20 dark:text-gray-300">
        <div className="mb-12">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            >
              Our approach to sustainability ensures we act in a socially
              responsible and environmentally respectful manner and that we
              continually measure, evaluate and increase sustainability efforts.
            </motion.div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10">
          {[
            {
              title: "Partners",
              text: "Collaborating as client-focused solution providers to deliver exceptional results to all stakeholders, all the time",
            },
            {
              title: "People",
              text: "Engaging employees by providing education, resources and support",
            },
            {
              title: "Projects",
              text: "Involvement in all phases of a project's life before, during and after its construction",
            },
            {
              title: "Practices",
              text: "Improving operations through measurement, communication and integration of sustainable building practices",
            },
          ].map((item, idx) => (
            <motion.div
              key={idx}
