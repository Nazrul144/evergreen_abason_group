...
const Sustainability4P: React.FC = () => {
  return (
    <section>
      <div className="lg:flex justify-between lg:px-44 md:px-10 lg:mt-20 dark:bg-gray-900">
        <motion.div
          className="dark:text-gray-300 w-[50%]"
  ...
  "
      ...
      <div className="lg:px-44 md:px-10 lg:mt-20 dark:bg-gray-900 dark:text-gray-300">
        <div className="mb-16">
          <motion.p
            className="text-sm uppercase tracking-wide text-gray-600 dark:text-gray-300 flex items-center gap-3"
            initial={{ x: -100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{
              delay: 0.2,
    ...
    bg-linear-to-r from-green-400 via-teal-500 to-blue-700
