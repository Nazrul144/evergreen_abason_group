...
import WorkTogetherBanner from "../newsPage/WorkTogetherBanner";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed dark:text-gray-300">
              Collaborating as client-focused solution providers to deliver
              exceptional results to all stakeholders, all the time
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed dark:text-gray-300">
              Involvement in all phases of a project&apos;s life before, during
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed dark:text-gray-300">
              Improving operations through measurement, communication and
