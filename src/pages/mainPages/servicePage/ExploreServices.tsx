    ...
    <section className="lg:px-44 md:px-10 lg:mt-20 dark:bg-gray-900 mb-20">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-start md:justify-between">
        ...
        <p className="mt-6 md:mt-0 max-w-md text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
          ...
          focus on safety, structural quality, and long-term value. Our
          experienced engineers and team ensure precision in every project we
          deliver.
        </p>
      </div>
        ...
        <div className="lg:p-14 space-y-16 max-h-screen overflow-y-auto mt-4 lg:mt-0">
          <div>
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
              ...
              Abason Group ensures long-lasting engineering excellence. Our
              commitment to durable construction, innovative design, and precise
              project execution makes us a reliable partner in shaping modern
              communities and future-ready structures.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto mt-20">
        <h3 className=" lg:text-3xl font-bold text-gray-900 dark:text-white mb-6">
          Our Specialized Service Categories
        </h3>
      ...
      <div className="max-w-7xl mx-auto mt-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300 leading-relaxed">
            No matter the scale or complexity, Evergreen Abason Group delivers
            premium construction services tailored to your vision. Our team
            handles every project with innovation, safety, and long-term
            reliability.
          </p>
