...
const Sustainability = () => {
  return (
    <section className="w-full px-4 md:px-10 lg:px-44 py-16 md:py-24 flex flex-col md:flex-row items-center dark:bg-gray-900 overflow-hidden justify-center lg:mb-24">
      {/* LEFT — Images */}
      <div className="relative w-full md:w-1/2 flex justify-center md:justify-start lg:ml-24">
        {/* Main Image */}
        <motion.div
        ...
        <motion.div
          className="
            ...
            absolute
            left-4 sm:left-0 lg:left-[100px]
            bottom-[-40px] sm:bottom-[-60px] lg:bottom-[-170px]
            max-w-full
          "
